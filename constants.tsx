...
export const NAV_ITEMS = [
  ...
  { id: Section.WORKFLOW, label: 'Workflow', icon: <Briefcase size={20} /> },
  { id: Section.FINANCE, label: 'Finanças', icon: <Wallet size={20} /> },
  { id: Section.HEALTH, label: 'Saúde Física', icon: <HeartPulse size={20} /> },
